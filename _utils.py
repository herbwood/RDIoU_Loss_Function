...
class BoxCoder:
    ...
    def decode(self, rel_codes, boxes):
        ...
        # get all the boxes in the batch
        # and concat by row 
        ...
        # if there is more than one bbox in the image
        # decode the boxes 
        if box_sum > 0:
...
class Matcher:
    ...
    def __init__(self, high_threshold:float, low_threshold:float, allow_low_quality_matches:bool = False):
        ...
        Args:
            ...
            low_threshold (float) : a lower quality threshold used to stratify
                ...
                2) BETWEEN_THESHOLD matches in [low_threshold, high_threshold]
    ...
    def __call__(self, match_quality_matrix:Tensor[float]):
        """
        Args:
        ...
        # if total number of match_quality_matrix is zero
        ...
        # matched_vals : best matching values 
        # matches : best matching value index 
    ...
    def set_low_quality_matches_(self, matches, all_matches, match_quality_matrix):
        ...
        it is unmatched, then match if to the ground-truth with which it has the highest
        quality value. 
        """
        # For each gt, find the prediction with which it has highest quality 
        # highest_quality_foreach_gt : highest iou values 
        highest_quality_foreach_gt, _ = match_quality_matrix.max(dim=1)
        # Find highest quality match available, even if it is low, including ties
        # tie means bbox having same iou value with different ground-truths
